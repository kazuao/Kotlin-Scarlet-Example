...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final WebsocketLibraryAccessors laccForWebsocketLibraryAccessors = new WebsocketLibraryAccessors(owner);
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for scarlet (com.tinder.scarlet:scarlet)
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    /**
     * Returns the group of libraries at message
     */
    ...
    /**
     * Returns the group of libraries at websocket
     */
    public WebsocketLibraryAccessors getWebsocket() {
        return laccForWebsocketLibraryAccessors;
    }
    ...
    public static class KotlinxSerializationLibraryAccessors extends SubDependencyFactory {
        ...
        public KotlinxSerializationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for runtime (org.jetbrains.kotlinx:kotlinx-serialization-runtime)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getRuntime() {
                return create("kotlinx.serialization.runtime");
        }
    ...
    public static class KotlinxSerializationJsonLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public KotlinxSerializationJsonLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for v122 (org.jetbrains.kotlinx:kotlinx-serialization-json)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getV122() {
                return create("kotlinx.serialization.json.v122");
        }

            /**
             * Creates a dependency provider for v163 (org.jetbrains.kotlinx:kotlinx-serialization-json)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getV163() {
                return create("kotlinx.serialization.json.v163");
        }
    ...
    public static class LifecycleLibraryAccessors extends SubDependencyFactory {
        ...
        public LifecycleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for android (com.tinder.scarlet:lifecycle-android)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAndroid() {
                return create("lifecycle.android");
        }

    }

    public static class MessageLibraryAccessors extends SubDependencyFactory {
        private final MessageAdapterLibraryAccessors laccForMessageAdapterLibraryAccessors = new MessageAdapterLibraryAccessors(owner);

        public MessageLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at message.adapter
         */
        public MessageAdapterLibraryAccessors getAdapter() {
            return laccForMessageAdapterLibraryAccessors;
        }

    }

    public static class MessageAdapterLibraryAccessors extends SubDependencyFactory {

        public MessageAdapterLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for gson (com.tinder.scarlet:message-adapter-gson)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getGson() {
                return create("message.adapter.gson");
        }

            /**
             * Creates a dependency provider for moshi (com.tinder.scarlet:message-adapter-moshi)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getMoshi() {
                return create("message.adapter.moshi");
        }
    ...
    public static class MoshiKotlinLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public MoshiKotlinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for v1120 (com.squareup.moshi:moshi-kotlin)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getV1120() {
                return create("moshi.kotlin.v1120");
        }
    ...
    public static class StreamLibraryAccessors extends SubDependencyFactory {
        private final StreamAdapterLibraryAccessors laccForStreamAdapterLibraryAccessors = new StreamAdapterLibraryAccessors(owner);

        public StreamLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at stream.adapter
         */
        public StreamAdapterLibraryAccessors getAdapter() {
            return laccForStreamAdapterLibraryAccessors;
        }

    }

    public static class StreamAdapterLibraryAccessors extends SubDependencyFactory {

        public StreamAdapterLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for coroutines (com.tinder.scarlet:stream-adapter-coroutines)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCoroutines() {
                return create("stream.adapter.coroutines");
        }

    }

    public static class WebsocketLibraryAccessors extends SubDependencyFactory {

        public WebsocketLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for okhttp (com.tinder.scarlet:websocket-okhttp)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getOkhttp() {
                return create("websocket.okhttp");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: jetbrainsKotlinxSerializationJson (1.2.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: kotlinxSerializationRuntime (0.20.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKotlinxSerializationRuntime() { return getVersion("kotlinxSerializationRuntime"); }

            /**
             * Returns the version associated to this alias: lifecycleAndroid (0.1.12)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getLifecycleAndroid() { return getVersion("lifecycleAndroid"); }
            ...
            /**
             * Returns the version associated to this alias: messageAdapterMoshi (0.1.12)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getMessageAdapterMoshi() { return getVersion("messageAdapterMoshi"); }

            /**
             * Returns the version associated to this alias: moshiKotlin (1.11.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: moshiKotlinVersion (1.12.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: okhttpBom (4.9.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: scarlet (0.1.12)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: scarletVersion (0.1.12)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getScarletVersion() { return getVersion("scarletVersion"); }

            /**
             * Returns the version associated to this alias: websocketOkhttp (0.1.12)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getWebsocketOkhttp() { return getVersion("websocketOkhttp"); }
